<%@ Page Title="" Language="C#" MasterPageFile="~/faculty_master_page.master" AutoEventWireup="true" CodeFile="class_master.aspx.cs" Inherits="class_master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
         ...
         <div class="ftco-section bg-light">
                <b>
                    <center><h1><span class="auto-style1">CLASS PAGE</span></h1></center>
                </b>
                <div class="container">
                    <div class="row">
...
<br />
    ...
    <asp:Button ID="btn_NEW" runat="server" Text="NEW" class="btn btn-primary" 
                     ...
                     <asp:Button ID="btn_danger" runat="server" Text="CREATE-SUBJECT" class="btn btn-danger" 
                     style="width:160px;" OnClick="btn_danger_Click"    />
